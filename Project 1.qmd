...
Topic - How does gross rent as a % of household income vary among different language speaking families? (We were more interested in finding income distribution among different attributes. However, the GRPIP variable seems not working in API function. Will revisit)
...
PUMS_tibble_census <- getPUMSsum(c(2021,2022),"JWAP","HHL","ST",filter_value="24", filter_column = "SCHL" )
