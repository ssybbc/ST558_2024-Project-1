...
getPUMSv4.2(2022,"GASP","HHL","ST","09")
```
...
# SS: There is a special thing about the level "ST". as a variable it is called "ST", but in the "for" call it is called "state". It was a pity they were not the same.
...
getPUMSv4.3 <- function (year = 2022, 
  ...
  PUMScustgeo <- httr::GET(url = base_url, query = query_params)
  PUMScustgeo_parsed <- fromJSON(rawToChar(PUMScustgeo$content))
  PUMScustgeo_tibble <- as_tibble (PUMScustgeo_parsed)
...
getPUMSv4.3(2022,"GASP","HHL","state","37")
