...
We fixed the issue in the below updated function getPUMSv2.1c
...
We updated the above code as follows. Function is choosecatv2
...
The column name issue is address in the following code "getPUMSv4.2b"
```{r}
...
Try one more time... Function "getPUMSv4.3b"
...
Topic - How does gross rent as a % of household income vary among different language speaking families?
(We were more interested in finding income distribution among different attributes. However, the GRPIP is not one of the user options and this variable seems not working in API function. Will revisit)
