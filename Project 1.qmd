...
# Set first row as column names
  # Function "unlist" simply turns the first row of data into a vector.
...
# SS: 2. Modified the tibble coding part. Use |> instead of %>% and adding more string to keep the coding compact. Droped the SCHL function that is previously encoded to speed up
